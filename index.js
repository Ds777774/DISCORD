...
let score = 0;
let questionResults = []; // Store results of each question 
...
    quizInProgress = true;
    score = 0;
    questionResults = []; // Reset the results of each question 
...
        // Store the result of each question
        questionResults.push({
          question: `What is the English meaning of "${currentWord.word}"?`,
...
    // Send results including correct and incorrect answers
    const resultEmbed = new EmbedBuilder()
      .setTitle('Quiz Results')
      .setDescription(`You scored ${score} out of 5!`)
      .setColor('#00FF00'); 

    const resultsDetail = questionResults.map((result, index) => {
